    ...
    <div class="bg-white text-gray-900 rounded-2xl shadow-2xl w-full max-w-md p-6 relative border border-gray-200 animate-fadeIn">
      ...
      <form @submit.prevent="submit" autocomplete="off">
        ...
        <div class="mb-4">
          ...
          <input v-model="form.name" type="text" class="w-full bg-white border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-400 focus:border-blue-500 text-gray-900 placeholder-gray-400 font-semibold transition-all duration-150" required placeholder="Category name" />
        </div>
