            ...
            <div class="footer-grid">
                <div class="footer-brand-col">
                    <a href="{{ route('welcome') }}" class="footer-brand">
                        ...
                        <span>Dunco<span class="text-blue-400">SMS</span></span>
                    </a>
                    <p class="footer-tagline">A comprehensive, all-in-one school management platform built for the modern educational institution.</p>
                ...
                <div class="footer-links-col">
                    ...
                    <ul>
                        ...
                        <li><a href="{{ route('public.demo') }}">Request Demo</a></li>
                    </ul>
                </div>
                ...
                <div class="footer-links-col">
                    <h4>Resources</h4>
                    <ul>
                        <li><a href="{{ route('welcome') }}#testimonials">Testimonials</a></li>
    ...
    <div class="footer-bottom">
        <div class="footer-container">
            <div class="footer-bottom-inner">
                <p>&copy; {{ date('Y') }} {{ config('app.name', 'Dunco School Management System') }}. All rights reserved.</p>
