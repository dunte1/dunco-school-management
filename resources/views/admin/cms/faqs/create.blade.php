...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-1"><i class="fas fa-plus-circle me-2 text-primary"></i>Add FAQ</h1>
            ...
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('category') is-invalid @enderror" id="category" name="category" value="{{ old('category') }}" list="categoryList" placeholder="e.g. Admissions, Fees, General">
