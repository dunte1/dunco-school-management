...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-1"><i class="fas fa-edit me-2 text-primary"></i>Edit Pricing Plan</h1>
    ...
    <form action="{{ route('admin.cms.pricing.update', $plan) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-lg-8">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control @error('currency') is-invalid @enderror" id="currency" name="currency" value="{{ old('currency', $plan->currency ?? 'USD') }}">
                                @error('currency')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-4">
                                ...
                                <select class="form-select @error('billing_period') is-invalid @enderror" id="billing_period" name="billing_period">
                                    ...
                                    <option value="one-time" {{ old('billing_period', $plan->billing_period) == 'one-time' ? 'selected' : '' }}>One-Time</option>
                                </select>
