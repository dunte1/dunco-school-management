...
Route::middleware(['web', 'auth'])->prefix('communication')->group(function () {
    Route::get('/', [CommunicationController::class, 'index'])->name('communication.dashboard');
    ...
    // Add missing routes
    Route::get('templates', [MessageController::class, 'templates'])->name('communication.templates');
    Route::get('settings', [MessageController::class, 'settings'])->name('communication.settings');
});
