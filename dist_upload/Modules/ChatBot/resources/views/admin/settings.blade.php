                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="openai_model" name="openai_model">
                                        <option value="gpt-3.5-turbo" {{ config('chatbot.openai.model') == 'gpt-3.5-turbo' ? 'selected' : '' }}>GPT-3.5 Turbo</option>
                                        <option value="gpt-4" {{ config('chatbot.openai.model') == 'gpt-4' ? 'selected' : '' }}>GPT-4</option>
                                        <option value="gpt-4-turbo" {{ config('chatbot.openai.model') == 'gpt-4-turbo' ? 'selected' : '' }}>GPT-4 Turbo</option>
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="openai_max_tokens" name="openai_max_tokens" 
                                           value="{{ config('chatbot.openai.max_tokens', 1000) }}" min="1" max="4000">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="openai_temperature" name="openai_temperature" 
                                           value="{{ config('chatbot.openai.temperature', 0.7) }}" min="0" max="2" step="0.1">
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="chatbot_enabled" name="chatbot_enabled" 
                                               {{ config('chatbot.chatbot.enabled', true) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="welcome_message" name="welcome_message" rows="2"
                                              placeholder="Hello! I'm your AI assistant...">{{ config('chatbot.chatbot.welcome_message') }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="max_conversation_length" name="max_conversation_length" 
                                           value="{{ config('chatbot.chatbot.max_conversation_length', 50) }}" min="10" max="100">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="session_timeout" name="session_timeout" 
                                           value="{{ config('chatbot.chatbot.session_timeout', 30) }}" min="5" max="120">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="requests_per_minute" name="requests_per_minute" 
                                           value="{{ config('chatbot.chatbot.rate_limit.requests_per_minute', 60) }}" min="10" max="200">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="requests_per_hour" name="requests_per_hour" 
                                           value="{{ config('chatbot.chatbot.rate_limit.requests_per_hour', 1000) }}" min="100" max="5000">
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="voice_input" name="voice_input" 
                                               {{ config('chatbot.features.voice_input', false) ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="voice_output" name="voice_output" 
                                               {{ config('chatbot.features.voice_output', false) ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="file_upload" name="file_upload" 
                                               {{ config('chatbot.features.file_upload', true) ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="code_generation" name="code_generation" 
                                               {{ config('chatbot.features.code_generation', true) ? 'checked' : '' }}>
