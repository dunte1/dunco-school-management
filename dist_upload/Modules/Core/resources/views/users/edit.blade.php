    ...
    <div class="col-lg-7 col-md-9">
        <div class="card shadow-sm border-0">
            <div class="card-header bg-primary text-white d-flex align-items-center">
                ...
                <div class="card-body">
                <form action="{{ route('core.users.update', $user->id) }}" method="POST" autocomplete="off" enctype="multipart/form-data" id="editUserForm">
                        @csrf
                        @method('PUT')
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="primary_role_id" name="primary_role_id">
                                ...
                                @foreach($roles as $role)
                                    <option value="{{ $role->id }}" {{ old('primary_role_id', $user->primary_role_id) == $role->id ? 'selected' : '' }}>
                                        {{ $role->display_name ?? $role->name }}
                                    </option>
                                @endforeach
                            </select>
