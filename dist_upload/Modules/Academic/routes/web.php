...
Route::middleware(['auth'])->prefix('academic')->name('academic.')->group(function () {
    ...
    Route::prefix('reports')->name('reports.')->group(function () {
        ...
        Route::get('/dashboard', [\Modules\Academic\Http\Controllers\ReportController::class, 'dashboard'])->name('dashboard');
    });

    // Grading System
    Route::prefix('grading')->name('grading.')->group(function () {
        Route::get('/', [\Modules\Academic\Http\Controllers\GradingController::class, 'index'])->name('index');
        Route::get('/create', [\Modules\Academic\Http\Controllers\GradingController::class, 'create'])->name('create');
        Route::post('/', [\Modules\Academic\Http\Controllers\GradingController::class, 'store'])->name('store');
        Route::get('/{id}/edit', [\Modules\Academic\Http\Controllers\GradingController::class, 'edit'])->name('edit');
        Route::put('/{id}', [\Modules\Academic\Http\Controllers\GradingController::class, 'update'])->name('update');
        Route::delete('/{id}', [\Modules\Academic\Http\Controllers\GradingController::class, 'destroy'])->name('destroy');

        // Grades nested under grading scale
        Route::post('/{scaleId}/grades', [\Modules\Academic\Http\Controllers\GradingController::class, 'storeGrade'])->name('grade.store');
        Route::put('/{scaleId}/grades/{gradeId}', [\Modules\Academic\Http\Controllers\GradingController::class, 'updateGrade'])->name('grade.update');
        Route::delete('/{scaleId}/grades/{gradeId}', [\Modules\Academic\Http\Controllers\GradingController::class, 'destroyGrade'])->name('grade.destroy');
    });

    // Student Enrollment
    Route::prefix('students')->name('students.')->group(function () {
        Route::get('/', [\Modules\Academic\Http\Controllers\StudentController::class, 'index'])->name('index');
        Route::get('/create', [\Modules\Academic\Http\Controllers\StudentController::class, 'create'])->name('create');
        Route::post('/', [\Modules\Academic\Http\Controllers\StudentController::class, 'store'])->name('store');
        Route::get('/{id}/edit', [\Modules\Academic\Http\Controllers\StudentController::class, 'edit'])->name('edit');
        Route::put('/{id}', [\Modules\Academic\Http\Controllers\StudentController::class, 'update'])->name('update');
        Route::delete('/{id}', [\Modules\Academic\Http\Controllers\StudentController::class, 'destroy'])->name('destroy');
        Route::get('/bulk-import', [\Modules\Academic\Http\Controllers\StudentController::class, 'showBulkImport'])->name('bulk_import');
        Route::post('/bulk-import', [\Modules\Academic\Http\Controllers\StudentController::class, 'handleBulkImport'])->name('handle_bulk_import');
        Route::post('/{id}/add-parent', [\Modules\Academic\Http\Controllers\StudentController::class, 'addParent'])->name('add_parent');
        Route::delete('/{id}/remove-parent/{parentId}', [\Modules\Academic\Http\Controllers\StudentController::class, 'removeParent'])->name('remove_parent');
        Route::post('/{id}/upload-document', [\Modules\Academic\Http\Controllers\StudentController::class, 'uploadDocument'])->name('upload_document');
        Route::delete('/{id}/delete-document/{docId}', [\Modules\Academic\Http\Controllers\StudentController::class, 'deleteDocument'])->name('delete_document');
        Route::post('/{id}/verify-document/{docId}', [\Modules\Academic\Http\Controllers\StudentController::class, 'verifyDocument'])->name('students.verify_document');
        Route::post('/{id}/record-payment/{feeId}', [\Modules\Academic\Http\Controllers\StudentController::class, 'recordPayment'])->name('students.record_payment');
        Route::get('/{id}/id-card', [\Modules\Academic\Http\Controllers\StudentController::class, 'idCard'])->name('students.id_card');
    });
