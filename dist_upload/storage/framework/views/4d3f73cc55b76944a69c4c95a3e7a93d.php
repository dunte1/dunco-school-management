    ...
    <div class="col-lg-7 col-md-9">
        <div class="card shadow-sm border-0">
            <div class="card-header bg-primary text-white d-flex align-items-center">
                ...
                <div class="card-body">
                <form action="<?php echo e(route('core.users.update', $user->id)); ?>" method="POST" autocomplete="off">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('core::layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\dunth\dunco school management system\duncoschool\Modules\Core\resources\views\users\edit.blade.php ENDPATH**/ ?>