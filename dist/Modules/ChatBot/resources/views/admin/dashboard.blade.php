...
@section('title', 'ChatBot Admin Dashboard')
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            ...
                                            <h3 id="totalConversations">{{ $statistics['total_conversations'] ?? 0 }}</h3>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            ...
                                            <h3 id="totalMessages">{{ $statistics['total_messages'] ?? 0 }}</h3>
                                        </div>
                                        <div class="align-self-center">
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            ...
                                            <h3 id="todayConversations">{{ $statistics['today_conversations'] ?? 0 }}</h3>
                                        </div>
                                        <div class="align-self-center">
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            ...
                                            <h3 id="todayMessages">{{ $statistics['today_messages'] ?? 0 }}</h3>
                                        </div>
                                        <div class="align-self-center">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="d-grid gap-2">
                                        <a href="{{ route('chatbot.admin.settings') }}" class="btn btn-outline-primary">
                                            ...
                                            <tbody>
                                                @if(isset($models) && count($models) > 0)
                                                    @foreach($models as $model)
                                                        <tr>
                                                            <td>{{ $model['id'] ?? 'N/A' }}</td>
                                                            <td>{{ isset($model['created']) ? \Carbon\Carbon::createFromTimestamp($model['created'])->format('Y-m-d H:i:s') : 'N/A' }}</td>
                                                            <td>{{ $model['object'] ?? 'N/A' }}</td>
                                                            <td>
