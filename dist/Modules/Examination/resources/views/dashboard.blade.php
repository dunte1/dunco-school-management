...
<div class="container py-4">
    ...
    <div class="glass-card p-4 mb-4">
        <div class="row g-4">
            ...
            <div class="col-md-4">
                <a href="{{ route('examination.student.exams') }}" class="text-decoration-none">
            ...
            <div class="col-md-4">
                <a href="{{ route('examination.student.history') }}" class="text-decoration-none">
                    <div class="card h-100 border-0 shadow-sm hover-lift">
                        <div class="card-body p-4">
                            <div class="d-flex align-items-center">
            ...
            <div class="col-md-4">
                <a href="{{ route('examination.student.results') }}" class="text-decoration-none">
                    <div class="card h-100 border-0 shadow-sm hover-lift">
                        <div class="card-body p-4">
                            <div class="d-flex align-items-center">
            ...
            <div class="col-md-4">
                <a href="{{ route('examination.questions.index') }}" class="text-decoration-none">
                    <div class="card h-100 border-0 shadow-sm hover-lift">
                        <div class="card-body p-4">
                            <div class="d-flex align-items-center">
            ...
            <div class="col-md-4">
                <a href="{{ route('examination.schedules.index') }}" class="text-decoration-none">
                    <div class="card h-100 border-0 shadow-sm hover-lift">
                        <div class="card-body p-4">
                            <div class="d-flex align-items-center">
                                <div class="bg-info bg-opacity-10 rounded-circle p-3 me-3">
            ...
            <div class="col-md-4">
                <a href="{{ route('examination.results.index') }}" class="text-decoration-none">
                    <div class="card h-100 border-0 shadow-sm hover-lift">
                        <div class="card-body p-4">
                            <div class="d-flex align-items-center">
                                <div class="bg-success bg-opacity-10 rounded-circle p-3 me-3">
