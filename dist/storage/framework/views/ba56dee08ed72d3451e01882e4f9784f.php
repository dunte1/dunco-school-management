...
<?php $__env->startSection('content'); ?>
                ...
                <div class="card shadow-sm border-0 h-100">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <div class="fw-bold fs-4"><?php echo e($totalClasses ?? 0); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card shadow-sm border-0 h-100">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <div class="fw-bold fs-4"><?php echo e($totalSubjects ?? 0); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card shadow-sm border-0 h-100">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <div class="fw-bold fs-4"><?php echo e($activeClasses ?? 0); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card shadow-sm border-0 h-100">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <div class="fw-bold fs-4"><?php echo e($totalStudents ?? 0); ?></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-body">
                ...
                <div class="d-flex flex-wrap gap-3">
                    <a href="<?php echo e(route('academic.classes.index')); ?>" class="btn btn-outline-primary"><i class="fas fa-chalkboard-teacher me-2"></i>Manage Classes</a>
                    <a href="<?php echo e(route('academic.subjects.index')); ?>" class="btn btn-outline-success"><i class="fas fa-book me-2"></i>Manage Subjects</a>
                    <a href="<?php echo e(route('academic.students.create')); ?>" class="btn btn-outline-info"><i class="fas fa-user-plus me-2"></i>Student Enrollment</a>
                    <a href="<?php echo e(route('academic.reports.index')); ?>" class="btn btn-outline-warning"><i class="fas fa-chart-bar me-2"></i>Academic Reports</a>
                </div>
            </div>
        </div>
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-body">
                ...
                <div class="d-flex flex-wrap gap-3">
                    <a href="<?php echo e(route('class_schedules.index')); ?>" class="btn btn-outline-primary"><i class="fas fa-calendar-alt me-2"></i>Class Schedules</a>
                    <a href="<?php echo e(route('rooms.index')); ?>" class="btn btn-outline-success"><i class="fas fa-door-open me-2"></i>Rooms</a>
                    <a href="<?php echo e(route('teacher_availabilities.index')); ?>" class="btn btn-outline-info"><i class="fas fa-user-clock me-2"></i>Teacher Availabilities</a>
                </div>
            </div>
        </div>
        <div class="card mt-4">
    ...
    <div class="card-body">
        <div class="d-flex flex-wrap gap-2">
            <a href="<?php echo e(url('/api/v1/class-schedules/export/csv')); ?>" class="btn btn-outline-primary" target="_blank">
                <i class="fas fa-file-csv"></i> Class Schedules (CSV)
            </a>
            <a href="<?php echo e(url('/api/v1/class-schedules/export/pdf')); ?>" class="btn btn-outline-danger" target="_blank">
                <i class="fas fa-file-pdf"></i> Class Schedules (PDF)
            </a>
            <a href="<?php echo e(url('/api/v1/teacher-availabilities/export/csv')); ?>" class="btn btn-outline-primary" target="_blank">
                <i class="fas fa-file-csv"></i> Teacher Availabilities (CSV)
            </a>
            <a href="<?php echo e(url('/api/v1/teacher-availabilities/export/pdf')); ?>" class="btn btn-outline-danger" target="_blank">
                <i class="fas fa-file-pdf"></i> Teacher Availabilities (PDF)
            </a>
            <a href="<?php echo e(url('/api/v1/rooms/export/csv')); ?>" class="btn btn-outline-primary" target="_blank">
                <i class="fas fa-file-csv"></i> Rooms (CSV)
            </a>
            <a href="<?php echo e(url('/api/v1/rooms/export/pdf')); ?>" class="btn btn-outline-danger" target="_blank">
                <i class="fas fa-file-pdf"></i> Rooms (PDF)
            </a>
            <a href="<?php echo e(url('/api/v1/room-allocations/export/csv')); ?>" class="btn btn-outline-primary" target="_blank">
                <i class="fas fa-file-csv"></i> Room Allocations (CSV)
            </a>
            <a href="<?php echo e(url('/api/v1/room-allocations/export/pdf')); ?>" class="btn btn-outline-danger" target="_blank">
        ...
        <div class="row g-3">
            <div class="col-12 col-md-6">
                <div class="card shadow-sm border-0 h-100">
                    <div class="card-body">
                        <div class="fw-bold mb-2" style="color:#1a237e;">Recent Classes <a href="<?php echo e(route('academic.classes.index')); ?>" class="btn btn-link btn-sm float-end">View All</a></div>
                        <?php if(isset($recentClasses) && count($recentClasses)): ?>
                            <ul class="list-group list-group-flush">
                                <?php $__currentLoopData = $recentClasses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="list-group-item"><?php echo e($class->name); ?></li>
            ...
            <div class="col-12 col-md-6">
                <div class="card shadow-sm border-0 h-100">
                    <div class="card-body">
                        <div class="fw-bold mb-2" style="color:#1a237e;">Recent Subjects <a href="<?php echo e(route('academic.subjects.index')); ?>" class="btn btn-link btn-sm float-end">View All</a></div>
                        <?php if(isset($recentSubjects) && count($recentSubjects)): ?>
                            <ul class="list-group list-group-flush">
                                <?php $__currentLoopData = $recentSubjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="list-group-item"><?php echo e($subject->name); ?></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        <?php else: ?>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const statData = [
                <?php echo e($stats['schools'] ?? 0); ?>,
                <?php echo e($stats['users'] ?? 0); ?>,
                <?php echo e($stats['roles'] ?? 0); ?>,
                <?php echo e($stats['permissions'] ?? 0); ?>,
                <?php echo e($stats['audit_logs'] ?? 0); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\dunth\dunco school management system\duncoschool\dist\Modules\Academic\resources\views\dashboard.blade.php ENDPATH**/ ?>