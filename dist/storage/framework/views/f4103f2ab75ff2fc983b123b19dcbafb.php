...
<div class="container mt-4">
    ...
    <table class="table table-bordered">
        ...
        <tbody id="feesTableBody">
            ...
            <tr data-id="<?php echo e($fee->id); ?>">
                <td><?php echo e($fee->name); ?></td>
                <td><?php echo e(number_format($fee->amount, 2)); ?></td>
                <td><pre class="mb-0"><?php echo e(json_encode($fee->applies_to, JSON_PRETTY_PRINT)); ?></pre></td>
                <td><?php echo e($fee->due_date ? $fee->due_date->format('Y-m-d') : ''); ?></td>
                <td>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\dunth\dunco school management system\duncoschool\dist\resources\views\admin\config\fees\index.blade.php ENDPATH**/ ?>