          ...
          <table class="table align-middle mb-0">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <?php if(isset($subject->classes) && count($subject->classes)): ?>
                    <?php echo e($subject->classes->pluck('name')->join(', ')); ?>
                ...
                <td>
                  <?php if(isset($subject->teachers) && count($subject->teachers)): ?>
                    <?php echo e($subject->teachers->pluck('name')->join(', ')); ?>
                ...
                <td>
                  <?php if(isset($subject->groups) && count($subject->groups)): ?>
                    <?php echo e($subject->groups->pluck('name')->join(', ')); ?>

                  <?php else: ?>
                    <span class="text-muted">None</span>
                  <?php endif; ?>
                </td>
                <td><?php echo e($subject->type ?? 'Core'); ?></td>
                <td>
                  <span class="badge bg-<?php echo e(isset($subject->exams_linked) && $subject->exams_linked ? 'success' : 'secondary'); ?>">
                    <?php echo e(isset($subject->exams_linked) && $subject->exams_linked ? 'Linked' : 'Not Linked'); ?>

                  </span>
                </td>
                <td>
                  <span class="badge bg-<?php echo e(isset($subject->timetable_scheduled) && $subject->timetable_scheduled ? 'success' : 'secondary'); ?>">
                    <?php echo e(isset($subject->timetable_scheduled) && $subject->timetable_scheduled ? 'Scheduled' : 'Not Scheduled'); ?>

                  </span>
                </td>
                <td>
                  <button class="btn btn-sm btn-info btn-performance" data-subject-id="<?php echo e($subject->id); ?>">View</button>
                </td>
                <td>
                  <button class="btn btn-sm btn-secondary btn-assign" data-subject-id="<?php echo e($subject->id); ?>">Assign</button>
                  <a href="<?php echo e(route('academic.subjects.edit', $subject->id)); ?>" class="btn btn-sm btn-warning btn-edit" data-subject-id="<?php echo e($subject->id); ?>">Edit</a>
                  <form action="<?php echo e(route('academic.subjects.destroy', $subject->id)); ?>" method="POST" class="d-inline delete-form">
                    <?php echo csrf_field(); ?>
                ...
                <select class="form-select" id="editClassIds" name="class_ids[]" multiple required>
                  <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($class->id); ?>"
                      <?php echo e((isset($subject) && $subject->classes->contains($class->id)) ? 'selected' : ''); ?>>
                ...
                <select class="form-select" id="editTeacherIds" name="teacher_ids[]" multiple required>
                  <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($teacher->id); ?>"
                      <?php echo e((isset($subject) && $subject->teachers->contains($teacher->id)) ? 'selected' : ''); ?>>
                ...
                <select class="form-select" id="editGroupIds" name="group_ids[]" multiple>
                  <?php $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($group->id); ?>"
                      <?php echo e((isset($subject) && $subject->groups->contains($group->id)) ? 'selected' : ''); ?>>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('academic::components.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\dunth\dunco school management system\duncoschool\dist\Modules\Academic\resources\views\subjects\index.blade.php ENDPATH**/ ?>