...
<div class="container">
    ...
    <form method="POST" action="<?php echo e(route('academic.students.store')); ?>">
        <?php echo csrf_field(); ?>
        <div class="mb-3">
        ...
        <div class="mb-3">
            <a href="<?php echo e(route('academic.students.bulk_import')); ?>" class="btn btn-outline-info">Bulk Enroll via Excel</a>
        </div>
...
<?php echo $__env->make('academic::layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\dunth\dunco school management system\duncoschool\dist\Modules\Academic\resources\views\students\create.blade.php ENDPATH**/ ?>