...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('transport.vehicles.store')); ?>">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="vehicle_number" name="vehicle_number" value="<?php echo e(old('vehicle_number')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        <option value="bus" <?php echo e(old('vehicle_type') == 'bus' ? 'selected' : ''); ?>>Bus</option>
                                        ...
                                        <option value="minibus" <?php echo e(old('vehicle_type') == 'minibus' ? 'selected' : ''); ?>>Minibus</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="year" name="year" value="<?php echo e(old('year')); ?>" min="1900" max="<?php echo e(date('Y') + 1); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="registration_number" name="registration_number" value="<?php echo e(old('registration_number')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="insurance_expiry" name="insurance_expiry" value="<?php echo e(old('insurance_expiry')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="fitness_expiry" name="fitness_expiry" value="<?php echo e(old('fitness_expiry')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="permit_expiry" name="permit_expiry" value="<?php echo e(old('permit_expiry')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="mileage" name="mileage" value="<?php echo e(old('mileage', 0)); ?>" min="0">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="text-end">
                            <a href="<?php echo e(route('transport.vehicles.index')); ?>" class="btn btn-secondary me-2">Cancel</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\dunth\dunco school management system\duncoschool\dist\Modules\Transport\resources\views\vehicles\create.blade.php ENDPATH**/ ?>