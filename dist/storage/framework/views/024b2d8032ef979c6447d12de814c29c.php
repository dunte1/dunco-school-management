...
<body>
    ...
    <nav class="sidebar d-flex flex-column shadow-lg" id="sidebarNav" aria-label="Main navigation" style="background: linear-gradient(135deg, #1a237e 0%, #3949ab 100%);">
        ...
        <?php endif; ?>
        <?php if(auth()->check() && (\App\Helpers\NavigationHelper::canAccessModule('hostel') || auth()->user()->hasRole('admin'))): ?>
                ...
                <div id="hostelCollapse" class="accordion-collapse collapse" aria-labelledby="hostelHeading" data-bs-parent="#hostelSidebarAccordion">
                    <div class="accordion-body p-0">
                        <nav class="nav flex-column ms-3">
                            ...
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('hostel.hostels.view')): ?>
        ...
        <?php endif; ?>
        <?php if(auth()->check() && (\App\Helpers\NavigationHelper::canAccessModule('transport') || auth()->user()->hasRole('admin'))): ?>
...
<?php /**PATH C:\Users\dunth\dunco school management system\duncoschool\dist\resources\views\layouts\app.blade.php ENDPATH**/ ?>