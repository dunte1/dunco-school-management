    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <p class="text-2xl font-bold text-blue-600"><?php echo e(number_format($stats['memory_usage']['current'] / 1024 / 1024, 2)); ?> MB</p>
                <p class="text-sm text-gray-500">Current Usage</p>
            </div>
            
            <div class="bg-white rounded-lg shadow p-6">
                <h3 class="text-lg font-semibold text-gray-700 mb-2">Peak Memory</h3>
                <p class="text-2xl font-bold text-green-600"><?php echo e(number_format($stats['memory_usage']['peak'] / 1024 / 1024, 2)); ?> MB</p>
                <p class="text-sm text-gray-500">Peak Usage</p>
            </div>
            
            <div class="bg-white rounded-lg shadow p-6">
                <h3 class="text-lg font-semibold text-gray-700 mb-2">Slow Queries</h3>
                <p class="text-2xl font-bold text-red-600"><?php echo e($stats['slow_queries']); ?></p>
                <p class="text-sm text-gray-500">Detected</p>
            </div>
            
            <div class="bg-white rounded-lg shadow p-6">
                <h3 class="text-lg font-semibold text-gray-700 mb-2">DB Connections</h3>
                <p class="text-2xl font-bold text-purple-600"><?php echo e($stats['database_connections']['active_connections'] ?? 0); ?></p>
...
</html> <?php /**PATH C:\Users\dunth\dunco school management system\duncoschool\dist\resources\views\performance\dashboard.blade.php ENDPATH**/ ?>