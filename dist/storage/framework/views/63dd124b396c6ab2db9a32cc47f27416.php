                    ...
                    <div class="row mb-3 g-3 justify-content-center">
                        ...
                        <div class="col-6 col-md-3">
                            <div class="card stat-card h-100 text-center border-0 glassmorphism p-3" style="min-height: 140px;">
                                <span class="stat-icon mb-1"><i class="fas fa-<?php echo e($stat['icon']); ?> text-<?php echo e($stat['color']); ?>"></i></span>
                                <canvas id="statChart<?php echo e($stat['i']); ?>" width="40" height="40" style="margin-bottom: 0.3rem;"></canvas>
                                <div class="fs-3 fw-bold"><?php echo e($stat['value']); ?></div>
                                <div class="fw-semibold small"><?php echo e($stat['label']); ?></div>
                                <div class="stat-trend mt-1" style="font-size:0.95rem;">
                                    <?php if($statTrends[$stat['i']]['change'] > 0): ?>
                                        <span style="color:#22c55e;"><i class="fas fa-arrow-up"></i> +<?php echo e($statTrends[$stat['i']]['change']); ?>%</span>
                                    <?php elseif($statTrends[$stat['i']]['change'] < 0): ?>
                                        <span style="color:#e53935;"><i class="fas fa-arrow-down"></i> <?php echo e($statTrends[$stat['i']]['change']); ?>%</span>
                                    <?php else: ?>
                ...
                <div class="col-12">
                    <div class="row g-3">
                        ...
                        <div class="col-6 col-md-4 col-lg-3">
                            <a href="<?php echo e($module['link']); ?>" class="card module-card border-0 shadow-sm text-decoration-none h-100 glassmorphism p-3 d-flex flex-column align-items-center justify-content-center" style="min-height: 140px;">
                                <span class="stat-icon mb-1" style="font-size:1.35rem;"><i class="fas fa-<?php echo e($module['icon']); ?> text-<?php echo e($module['color']); ?>"></i></span>
                                <div class="fw-bold mb-1" style="font-size:1.22rem;color:#eaf6fb;text-shadow:0 1px 8px rgba(30,167,255,0.13);letter-spacing:0.5px;"><?php echo e($module['title']); ?></div>
                                <div class="text-muted text-center small" style="font-size:0.97rem;line-height:1.3;"><?php echo e($module['desc']); ?></div>
                            </a>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                            ...
                            <?php else: ?>
                                <?php $__currentLoopData = [
                                    ...
                                    <?php if($activityCount < 3): ?>
                                        <li class="mb-3 d-flex align-items-center">
                                            <i class="fas fa-<?php echo e($activity['icon']); ?> text-<?php echo e($activity['color']); ?> me-2"></i>
                                            <span class="activity-feed-label"><?php echo e($activity['label']); ?></span>
                                            <?php if($activity['entity']): ?> <span class="activity-feed-entity"><b><?php echo e($activity['entity']); ?></b></span> <?php endif; ?>
                                            <span class="activity-feed-action"><?php echo e($activity['action']); ?></span>
                                            <span class="activity-feed-time ms-2 small"><?php echo e($activity['time']); ?></span>
                                        </li>
                                        <?php $activityCount++; ?>
                                    <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\dunth\dunco school management system\duncoschool\dist\resources\views\dashboard.blade.php ENDPATH**/ ?>