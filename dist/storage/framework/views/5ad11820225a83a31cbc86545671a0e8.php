...
<div class="roles-premium-card">
    <div class="roles-header-premium mb-3">
        ...
        <h1>Roles</h1>
        <a href="<?php echo e(route('core.roles.create')); ?>" class="roles-add-btn ms-auto">
                    ...
                    <td>
                        <?php if($role->permissions->count() > 0): ?>
                            <?php $__currentLoopData = $role->permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span class="roles-permission-badge"><?php echo e($permission->display_name ?? $permission->name); ?></span>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php else: ?>
                            <span class="text-muted">No permissions assigned</span>
                        <?php endif; ?>
                        <!-- Debug: <?php echo e($role->permissions->count()); ?> permissions loaded -->
                    </td>
                    <td>
                        <a href="<?php echo e(route('core.roles.show', $role->id)); ?>" class="roles-action-btn view" title="View" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="View">
                            <i class="fas fa-eye"></i>
                        </a>
                        <a href="<?php echo e(route('core.roles.edit', $role->id)); ?>" class="roles-action-btn edit" title="Edit" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\dunth\dunco school management system\duncoschool\dist\Modules\Core\resources\views\roles\index.blade.php ENDPATH**/ ?>