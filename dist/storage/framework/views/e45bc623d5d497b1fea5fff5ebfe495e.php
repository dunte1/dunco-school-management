        ...
        <table class="table align-middle mb-0">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <?php if($school->logo): ?>
                            <img src="<?php echo e(asset('storage/' . $school->logo)); ?>" alt="Logo" class="rounded" width="40" height="40">
                        <?php else: ?>
                    ...
                    <td><?php echo e($school->domain); ?></td>
                    <td>
                    ...
                    <td>
                        <span class="badge bg-info"><?php echo e(optional($school->users)->count() ?? 0); ?></span>
                    </td>
                    <td><?php echo e($school->created_at ? $school->created_at->format('M d, Y') : ''); ?></td>
                    <td>
                        <a href="<?php echo e(route('core.schools.show', $school->id)); ?>" class="schools-action-btn view" title="View" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="View">
                            <i class="fas fa-eye"></i>
                        </a>
                        <a href="<?php echo e(route('core.schools.edit', $school->id)); ?>" class="schools-action-btn edit" title="Edit" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit">
                            <i class="fas fa-edit"></i>
                        </a>
                        <button class="schools-action-btn delete" title="Delete" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Delete" onclick="confirmDelete(<?php echo e($school->id); ?>, '<?php echo e($school->name); ?>')">
                            <i class="fas fa-trash"></i>
                        </button>
                        <form id="delete-form-<?php echo e($school->id); ?>" action="<?php echo e(route('core.schools.destroy', $school->id)); ?>" method="POST" style="display:none;">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('core::schools.modals', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<script>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\dunth\dunco school management system\duncoschool\dist\Modules\Core\resources\views\schools\index.blade.php ENDPATH**/ ?>