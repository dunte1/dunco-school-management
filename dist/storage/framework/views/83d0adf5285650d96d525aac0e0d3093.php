                        ...
                        <table class="table table-hover table-striped align-middle mb-0" id="auditLogTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#viewLogModal" onclick="showLogDetails(<?php echo e($log->id); ?>, '<?php echo e($log->user_id); ?>', '<?php echo e($log->action); ?>', '<?php echo e($log->description); ?>', '<?php echo e($log->created_at); ?>', <?php echo json_encode($log->old_values, 15, 512) ?>, <?php echo json_encode($log->new_values, 15, 512) ?>)" title="View" data-bs-placement="top" data-bs-title="View">
...
<?php endif; ?> <?php /**PATH C:\Users\dunth\dunco school management system\duncoschool\dist\Modules\Core\resources\views\audit_logs\index.blade.php ENDPATH**/ ?>