            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo e(route('transport.vehicles.show', $vehicle)); ?>"><?php echo e($vehicle->vehicle_number); ?></a></li>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('transport.vehicles.update', $vehicle)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control <?php $__errorArgs = ['vehicle_number'];
...
unset($__errorArgs, $__bag); ?>" 
                                           ...
                                           value="<?php echo e(old('vehicle_number', $vehicle->vehicle_number)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                           ...
                                           value="<?php echo e(old('registration_number', $vehicle->registration_number)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        <option value="bus" <?php echo e(old('vehicle_type', $vehicle->vehicle_type) == 'bus' ? 'selected' : ''); ?>>Bus</option>
                                        <option value="van" <?php echo e(old('vehicle_type', $vehicle->vehicle_type) == 'van' ? 'selected' : ''); ?>>Van</option>
                                        <option value="car" <?php echo e(old('vehicle_type', $vehicle->vehicle_type) == 'car' ? 'selected' : ''); ?>>Car</option>
                                        <option value="minibus" <?php echo e(old('vehicle_type', $vehicle->vehicle_type) == 'minibus' ? 'selected' : ''); ?>>Minibus</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        <option value="active" <?php echo e(old('status', $vehicle->status) == 'active' ? 'selected' : ''); ?>>Active</option>
                                        <option value="maintenance" <?php echo e(old('status', $vehicle->status) == 'maintenance' ? 'selected' : ''); ?>>Maintenance</option>
                                        <option value="inactive" <?php echo e(old('status', $vehicle->status) == 'inactive' ? 'selected' : ''); ?>>Inactive</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>" 
                                           ...
                                           value="<?php echo e(old('insurance_expiry', $vehicle->insurance_expiry->format('Y-m-d'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control <?php $__errorArgs = ['fitness_expiry'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                           ...
                                           value="<?php echo e(old('fitness_expiry', $vehicle->fitness_expiry->format('Y-m-d'))); ?>" required>
                                    <?php $__errorArgs = ['fitness_expiry'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control <?php $__errorArgs = ['permit_expiry'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                           ...
                                           value="<?php echo e(old('permit_expiry', $vehicle->permit_expiry->format('Y-m-d'))); ?>" required>
                                    <?php $__errorArgs = ['permit_expiry'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                              id="description" name="description" rows="3"><?php echo e(old('description', $vehicle->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select <?php $__errorArgs = ['route_ids'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        <?php $__currentLoopData = $routes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $route): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($route->id); ?>" 
                                                <?php echo e(in_array($route->id, old('route_ids', $vehicle->routes->pluck('id')->toArray())) ? 'selected' : ''); ?>>
                                                <?php echo e($route->name); ?> (<?php echo e($route->stops->count()); ?> stops)
                                            </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                    <?php $__errorArgs = ['route_ids'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="d-flex justify-content-end gap-2">
                                    <a href="<?php echo e(route('transport.vehicles.show', $vehicle)); ?>" class="btn btn-secondary">
...
<?php $__env->stopPush(); ?> 
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\dunth\dunco school management system\duncoschool\dist\Modules\Transport\resources\views\vehicles\edit.blade.php ENDPATH**/ ?>