...
<div class="container py-4">
    ...
    <form id="attendance-form">
        <div class="row mb-3">
            ...
            <div class="col-md-3">
                <label>Date</label>
                <input type="date" class="form-control" name="date" id="date" value="<?php echo e(date('Y-m-d')); ?>">
            </div>
            <div class="col-md-3">
...
<?php $__env->stopPush(); ?> 
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\dunth\dunco school management system\duncoschool\dist\resources\views\modules\attendance\mark.blade.php ENDPATH**/ ?>