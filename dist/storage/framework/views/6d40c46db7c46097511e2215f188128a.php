...
<div class="modal fade" id="addSchoolModal" tabindex="-1" aria-labelledby="addSchoolModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="addSchoolForm" action="<?php echo e(route('core.schools.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>" id="domain" name="domain" value="<?php echo e(old('domain')); ?>" placeholder="e.g., school.example.com">
...
</div> <?php /**PATH C:\Users\dunth\dunco school management system\duncoschool\dist\Modules\Core\resources\views\schools\modals.blade.php ENDPATH**/ ?>