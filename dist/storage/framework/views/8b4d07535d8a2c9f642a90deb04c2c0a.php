    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('academic.classes.store')); ?>" id="classForm">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="capacity" name="capacity" value="<?php echo e(old('capacity', 30)); ?>" 
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select <?php $__errorArgs = ['academic_year'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                        ...
                        <div class="mb-3">
                                    ...
                                    <div class="col-md-4 mb-2">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="subject_<?php echo e($subject->id); ?>">
                                                ...
                                                <br><small class="text-muted"><?php echo e($subject->code); ?> (<?php echo e($subject->credits); ?> credits)</small>
                                            </label>
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php if($subjects->count() == 0): ?>
                                <div class="alert alert-info">
                                    ...
                                    No subjects available. <a href="<?php echo e(route('academic.subjects.create')); ?>">Create subjects first</a>.
                                </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <?php $__currentLoopData = $recentClasses ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="list-group-item d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <small class="text-muted"><?php echo e($class->code); ?></small>
                                </div>
                                <span class="badge badge-primary badge-pill"><?php echo e($class->academic_year); ?></span>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
...
<?php echo $__env->make('academic::components.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\dunth\dunco school management system\duncoschool\dist\Modules\Academic\resources\views\classes\create.blade.php ENDPATH**/ ?>