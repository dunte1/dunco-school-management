    ...
    <div class="card mt-4">
        ...
        <div class="card-body">
            <form id="bulk-notify-form" class="row g-2 align-items-end">
                ...
                <div class="col-md-2">
                    <label>Date</label>
                    <input type="date" class="form-control" id="bulk-date" value="<?php echo e(date('Y-m-d')); ?>">
                </div>
                <div class="col-md-3">
                    <label>Message</label>
...
<?php $__env->stopPush(); ?> 
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\dunth\dunco school management system\duncoschool\dist\resources\views\modules\attendance\reports.blade.php ENDPATH**/ ?>