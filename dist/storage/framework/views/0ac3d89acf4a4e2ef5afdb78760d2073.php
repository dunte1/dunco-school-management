    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('core.permissions.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>" id="display_name" name="display_name" value="<?php echo e(old('display_name')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="module" name="module" value="<?php echo e(old('module', 'Core')); ?>">
...
<?php endif; ?> <?php /**PATH C:\Users\dunth\dunco school management system\duncoschool\dist\Modules\Core\resources\views\permissions\create.blade.php ENDPATH**/ ?>