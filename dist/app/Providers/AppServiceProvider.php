...
class AppServiceProvider extends ServiceProvider
{
    ...
    {
        // Laravel Modules will be registered by the package itself
        
        // Manually register Transport module
        $this->app->register(\Modules\Transport\Providers\TransportServiceProvider::class);
    }
