...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0">Hostel Management</h1>
        <div class="text-muted">Hostel overview and management</div>
    </div>
    ...
    <div class="row mb-4">
        ...
        <div class="col-lg-6">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    @php
                        $totalRooms = $stats['total_rooms'] ?? 1;
                    ...
                    <p class="mb-0"><strong>Total Rooms:</strong> {{ $totalRooms }}</p>
                </div>
            </div>
        </div>
    </div>
