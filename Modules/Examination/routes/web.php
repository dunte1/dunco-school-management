...
use Modules\Examination\Http\Controllers\OnlineExamController;
use Modules\Examination\Http\Controllers\QuestionController;
use Modules\Examination\Http\Controllers\QuestionCategoryController;
...
Route::prefix('examination')->name('examination.')->middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('online')->name('online.')->group(function () {
        ...
        Route::get('/exam/{exam}/take', [OnlineExamController::class, 'takeExam'])->name('take');
...
Route::prefix('api/examination')->name('api.examination.')->middleware(['auth:sanctum','throttle:60,1'])->group(function () {
