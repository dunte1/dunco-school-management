...
<div class="container mx-auto p-4">
    <h1 class="text-2xl font-bold mb-4">Results {{ isset($examModel) && $examModel ? '— '.$examModel->name : '' }}</h1>
    ...
    <table class="min-w-full bg-white rounded shadow">
        ...
        @empty
            <tr><td colspan="4" class="px-4 py-6 text-center text-gray-500">No results recorded.</td></tr>
        @endforelse
        </tbody>
    </table>
</div>
