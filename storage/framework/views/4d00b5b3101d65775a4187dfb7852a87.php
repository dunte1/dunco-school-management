<?php $__env->startSection('title', 'Finance Dashboard - Dunco School Management System'); ?>
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            ...
            <a href="<?php echo e(route('finance.settings.index')); ?>" class="btn btn-outline-primary">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <h4 class="mb-0">KES <?php echo e(number_format($stats['total_fees_collected'] ?? 0, 2)); ?></h4>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <h4 class="mb-0">KES <?php echo e(number_format($stats['outstanding_balances'] ?? 0, 2)); ?></h4>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <h4 class="mb-0"><?php echo e(number_format($stats['active_students'] ?? 0)); ?></h4>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <h4 class="mb-0"><?php echo e(number_format($stats['bank_accounts'] ?? 0)); ?></h4>
        ...
        <div class="col-xl-2 col-md-4 col-sm-6 mb-3">
            <div class="card border-0 shadow-sm h-100 text-decoration-none">
                <div class="card-body text-center">
                    ...
                    <p class="text-muted small mb-0"><?php echo e($stats['total_fees'] ?? 0); ?> fees</p>
                    <a href="<?php echo e(route('finance.fees.index')); ?>" class="stretched-link"></a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-2 col-md-4 col-sm-6 mb-3">
            <div class="card border-0 shadow-sm h-100 text-decoration-none">
                <div class="card-body text-center">
                    ...
                    <a href="<?php echo e(route('finance.billing.index')); ?>" class="stretched-link"></a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-2 col-md-4 col-sm-6 mb-3">
            <div class="card border-0 shadow-sm h-100 text-decoration-none">
                <div class="card-body text-center">
                    ...
                    <p class="text-muted small mb-0"><?php echo e($stats['pending_payments'] ?? 0); ?> pending</p>
                    <a href="<?php echo e(route('finance.payments.index')); ?>" class="stretched-link"></a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-2 col-md-4 col-sm-6 mb-3">
            <div class="card border-0 shadow-sm h-100 text-decoration-none">
                <div class="card-body text-center">
                    ...
                    <a href="<?php echo e(route('finance.receipts.index')); ?>" class="stretched-link"></a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-2 col-md-4 col-sm-6 mb-3">
            <div class="card border-0 shadow-sm h-100 text-decoration-none">
                <div class="card-body text-center">
                    ...
                    <a href="<?php echo e(route('finance.reports.index')); ?>" class="stretched-link"></a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-2 col-md-4 col-sm-6 mb-3">
            <div class="card border-0 shadow-sm h-100 text-decoration-none">
                <div class="card-body text-center">
                    ...
                    <a href="<?php echo e(route('finance.settings.index')); ?>" class="stretched-link"></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-xl-2 col-md-4 col-sm-6 mb-3">
            <div class="card border-0 shadow-sm h-100 text-decoration-none">
                <div class="card-body text-center">
                    ...
                    <a href="<?php echo e(route('finance.banks.index')); ?>" class="stretched-link"></a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-2 col-md-4 col-sm-6 mb-3">
            <div class="card border-0 shadow-sm h-100 text-decoration-none">
                <div class="card-body text-center">
                    ...
                    <a href="<?php echo e(route('finance.bank-reconciliation.index')); ?>" class="stretched-link"></a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-2 col-md-4 col-sm-6 mb-3">
            <div class="card border-0 shadow-sm h-100 text-decoration-none">
                <div class="card-body text-center">
                    ...
                    <a href="<?php echo e(route('finance.gl.index')); ?>" class="stretched-link"></a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-2 col-md-4 col-sm-6 mb-3">
            <div class="card border-0 shadow-sm h-100 text-decoration-none">
                <div class="card-body text-center">
                    ...
                    <a href="<?php echo e(route('finance.forecasting.index')); ?>" class="stretched-link"></a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-2 col-md-4 col-sm-6 mb-3">
            <div class="card border-0 shadow-sm h-100 text-decoration-none">
                <div class="card-body text-center">
                    ...
                    <a href="<?php echo e(route('finance.online-payments.index')); ?>" class="stretched-link"></a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-2 col-md-4 col-sm-6 mb-3">
            <div class="card border-0 shadow-sm h-100 text-decoration-none">
                <div class="card-body text-center">
                    ...
                    <a href="<?php echo e(route('finance.roles.index')); ?>" class="stretched-link"></a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\dunth\Documents\duncoschool\Modules/Finance/resources/views/index.blade.php ENDPATH**/ ?>