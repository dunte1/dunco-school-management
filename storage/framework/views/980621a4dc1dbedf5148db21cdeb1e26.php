    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
<form method="POST" action="<?php echo e(route('hr.staff.store')); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\dunth\Documents\duncoschool\Modules/HR/resources/views/staff/create.blade.php ENDPATH**/ ?>