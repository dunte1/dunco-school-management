...
<body>
    ...
    <nav class="sidebar d-flex flex-column shadow-lg" id="sidebarNav" aria-label="Main navigation" style="background: linear-gradient(135deg, #1a237e 0%, #3949ab 100%);">
        ...
        <?php if(\App\Helpers\NavigationHelper::canAccessModule('compliance') || \App\Helpers\NavigationHelper::canAccessModule('audit') || auth()->user()->hasRole('admin')): ?>
        ...
        <div class="accordion mb-2" id="complianceSidebarAccordion">
            <div class="accordion-item border-0 bg-transparent">
                ...
                <div id="complianceCollapse" class="accordion-collapse collapse" aria-labelledby="complianceHeading" data-bs-parent="#complianceSidebarAccordion">
                    <div class="accordion-body p-0">
                        <nav class="nav flex-column ms-3">
                            <?php if(auth()->user()->hasPermission('compliance.view')): ?>
                            <a href="/compliance" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->is('compliance')): ?> active <?php endif; ?>">
                                <i class="fas fa-home me-2"></i> Dashboard
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('compliance.manage.view')): ?>
                            <a href="/compliance/manage" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->is('compliance/manage*')): ?> active <?php endif; ?>">
            ...
            <div class="accordion-item border-0 bg-transparent">
                ...
                <div id="auditCollapse" class="accordion-collapse collapse" aria-labelledby="auditHeading" data-bs-parent="#auditSidebarAccordion">
                    <div class="accordion-body p-0">
                        <nav class="nav flex-column ms-3">
                            <?php if(auth()->user()->hasPermission('audit.view')): ?>
                            <a href="<?php echo e(route('audit.index')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('audit.index')): ?> active <?php endif; ?>">
                                <i class="fas fa-home me-2"></i> Dashboard
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('audit.manage.view')): ?>
                            <a href="<?php echo e(route('audit.manage.index')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('audit.manage.*')): ?> active <?php endif; ?>">
                                <i class="fas fa-cogs me-2"></i> Manage
                            </a>
                            <?php endif; ?>
                        </nav>
        ...
        <?php endif; ?>
        <?php if(\App\Helpers\NavigationHelper::canAccessModule('lms') || auth()->user()->hasRole('admin')): ?>
        ...
        <div class="accordion mb-2" id="lmsSidebarAccordion">
            <div class="accordion-item border-0 bg-transparent">
                ...
                <div id="lmsCollapse" class="accordion-collapse collapse" aria-labelledby="lmsHeading" data-bs-parent="#lmsSidebarAccordion">
                    <div class="accordion-body p-0">
                        <nav class="nav flex-column ms-3">
                            <?php if(auth()->user()->hasPermission('lms.view')): ?>
                            <a href="/lms" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->is('lms')): ?> active <?php endif; ?>">
                                <i class="fas fa-home me-2"></i> Dashboard
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('lms.courses.view')): ?>
                            <a href="/lms/courses" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->is('lms/courses*')): ?> active <?php endif; ?>">
                                <i class="fas fa-book me-2"></i> Courses
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('lms.assignments.view')): ?>
                            <a href="/lms/assignments" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->is('lms/assignments*')): ?> active <?php endif; ?>">
                                <i class="fas fa-tasks me-2"></i> Assignments
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('lms.grades.view')): ?>
                            <a href="/lms/grades" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->is('lms/grades*')): ?> active <?php endif; ?>">
            ...
            <div class="accordion-item border-0 bg-transparent">
                ...
                <div id="analyticsCollapse" class="accordion-collapse collapse" aria-labelledby="analyticsHeading" data-bs-parent="#analyticsSidebarAccordion">
                    <div class="accordion-body p-0">
                        <nav class="nav flex-column ms-3">
                            <?php if(auth()->user()->hasPermission('analytics.view')): ?>
                            <a href="/analytics" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->is('analytics')): ?> active <?php endif; ?>">
                                <i class="fas fa-home me-2"></i> Dashboard
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('analytics.reports.view')): ?>
                            <a href="/analytics/reports" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->is('analytics/reports*')): ?> active <?php endif; ?>">
                                <i class="fas fa-chart-bar me-2"></i> Reports
                            </a>
                            <?php endif; ?>
                        </nav>
        ...
        <?php endif; ?>
        <?php if(auth()->user()->hasPermission('marketplace.view')): ?>
            ...
            <div class="accordion-item border-0 bg-transparent">
                ...
                <div id="marketplaceCollapse" class="accordion-collapse collapse" aria-labelledby="marketplaceHeading" data-bs-parent="#marketplaceSidebarAccordion">
                    <div class="accordion-body p-0">
                        <nav class="nav flex-column ms-3">
                            <?php if(auth()->user()->hasPermission('marketplace.view')): ?>
                            <a href="/marketplace" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->is('marketplace')): ?> active <?php endif; ?>">
                                <i class="fas fa-home me-2"></i> Dashboard
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('marketplace.manage.view')): ?>
                            <a href="/marketplace/manage" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->is('marketplace/manage*')): ?> active <?php endif; ?>">
                                <i class="fas fa-cogs me-2"></i> Manage
                            </a>
                            <?php endif; ?>
                        </nav>
        ...
        <?php endif; ?>
        <?php if(auth()->user()->hasPermission('pwa.view')): ?>
            ...
            <div class="accordion-item border-0 bg-transparent">
                ...
                <div id="pwaCollapse" class="accordion-collapse collapse" aria-labelledby="pwaHeading" data-bs-parent="#pwaSidebarAccordion">
                    <div class="accordion-body p-0">
                        <nav class="nav flex-column ms-3">
                            <?php if(auth()->user()->hasPermission('pwa.view')): ?>
                            <a href="/pwa" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->is('pwa*')): ?> active <?php endif; ?>">
                                <i class="fas fa-home me-2"></i> Dashboard
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('pwa.manage.view')): ?>
                            <a href="/pwa/manage" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->is('pwa/manage*')): ?> active <?php endif; ?>">
                                <i class="fas fa-cogs me-2"></i> Manage
                            </a>
                            <?php endif; ?>
                        </nav>
        ...
        <?php endif; ?>
        <?php if(auth()->user()->hasPermission('research.view')): ?>
            ...
            <div class="accordion-item border-0 bg-transparent">
                ...
                <div id="researchCollapse" class="accordion-collapse collapse" aria-labelledby="researchHeading" data-bs-parent="#researchSidebarAccordion">
                    <div class="accordion-body p-0">
                        <nav class="nav flex-column ms-3">
                            <?php if(auth()->user()->hasPermission('research.view')): ?>
                            <a href="/research" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->is('research')): ?> active <?php endif; ?>">
                                <i class="fas fa-home me-2"></i> Dashboard
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('research.manage.view')): ?>
                            <a href="/research/manage" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->is('research/manage*')): ?> active <?php endif; ?>">
                                <i class="fas fa-cogs me-2"></i> Manage
                            </a>
                            <?php endif; ?>
                        </nav>
        ...
        <?php if(\App\Helpers\NavigationHelper::canAccessModule('welfare') || \App\Helpers\NavigationHelper::canAccessModule('cafeteria') || auth()->user()->hasRole('admin')): ?>
        ...
        <div class="accordion mb-2" id="welfareSidebarAccordion">
            <div class="accordion-item border-0 bg-transparent">
                ...
                <div id="welfareCollapse" class="accordion-collapse collapse" aria-labelledby="welfareHeading" data-bs-parent="#welfareSidebarAccordion">
                    <div class="accordion-body p-0">
                        <nav class="nav flex-column ms-3">
                            <?php if(auth()->user()->hasPermission('welfare.view')): ?>
                            <a href="/welfare" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->is('welfare')): ?> active <?php endif; ?>">
                                <i class="fas fa-home me-2"></i> Dashboard
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('welfare.manage')): ?>
                            <a href="/welfare/manage" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->is('welfare/manage*')): ?> active <?php endif; ?>">
                                <i class="fas fa-cogs me-2"></i> Manage
                            </a>
                            <?php endif; ?>
                        </nav>
        ...
        <div class="accordion mb-2" id="cafeteriaSidebarAccordion">
            <div class="accordion-item border-0 bg-transparent">
                ...
                <div id="cafeteriaCollapse" class="accordion-collapse collapse" aria-labelledby="cafeteriaHeading" data-bs-parent="#cafeteriaSidebarAccordion">
                    <div class="accordion-body p-0">
                        <nav class="nav flex-column ms-3">
                            <?php if(auth()->user()->hasPermission('cafeteria.view')): ?>
                            <a href="/cafeteria" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->is('cafeteria')): ?> active <?php endif; ?>">
                                <i class="fas fa-home me-2"></i> Dashboard
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('cafeteria.manage')): ?>
                            <a href="/cafeteria/manage" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->is('cafeteria/manage*')): ?> active <?php endif; ?>">
                                <i class="fas fa-cogs me-2"></i> Manage
                            </a>
                            <?php endif; ?>
                        </nav>
        ...
        <?php if(\App\Helpers\NavigationHelper::canAccessModule('inventory') || \App\Helpers\NavigationHelper::canAccessModule('assets') || auth()->user()->hasRole('admin')): ?>
        ...
        <div class="accordion mb-2" id="inventorySidebarAccordion">
            <div class="accordion-item border-0 bg-transparent">
                ...
                <div id="inventoryCollapse" class="accordion-collapse collapse" aria-labelledby="inventoryHeading" data-bs-parent="#inventorySidebarAccordion">
                    <div class="accordion-body p-0">
                        <nav class="nav flex-column ms-3">
                            <?php if(auth()->user()->hasPermission('inventory.view')): ?>
                            <a href="/inventory" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->is('inventory')): ?> active <?php endif; ?>">
                                <i class="fas fa-home me-2"></i> Dashboard
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('inventory.manage')): ?>
                            <a href="/inventory/manage" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->is('inventory/manage*')): ?> active <?php endif; ?>">
                                <i class="fas fa-cogs me-2"></i> Manage
                            </a>
                            <?php endif; ?>
                        </nav>
        ...
        <div class="accordion mb-2" id="assetsSidebarAccordion">
            <div class="accordion-item border-0 bg-transparent">
                ...
                <div id="assetsCollapse" class="accordion-collapse collapse" aria-labelledby="assetsHeading" data-bs-parent="#assetsSidebarAccordion">
                    <div class="accordion-body p-0">
                        <nav class="nav flex-column ms-3">
                            <?php if(auth()->user()->hasPermission('assets.view')): ?>
                            <a href="/assets" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->is('assets')): ?> active <?php endif; ?>">
                                <i class="fas fa-home me-2"></i> Dashboard
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('assets.manage')): ?>
                            <a href="/assets/manage" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->is('assets/manage*')): ?> active <?php endif; ?>">
                                <i class="fas fa-cogs me-2"></i> Manage
                            </a>
                            <?php endif; ?>
                        </nav>
        ...
        <?php if(\App\Helpers\NavigationHelper::canAccessModule('alumni') || auth()->user()->hasRole('admin')): ?>
        ...
        <div class="accordion mb-2" id="alumniSidebarAccordion">
            <div class="accordion-item border-0 bg-transparent">
                ...
                <div id="alumniCollapse" class="accordion-collapse collapse" aria-labelledby="alumniHeading" data-bs-parent="#alumniSidebarAccordion">
                    <div class="accordion-body p-0">
                        <nav class="nav flex-column ms-3">
                            <?php if(auth()->user()->hasPermission('alumni.view')): ?>
                            <a href="/alumni" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->is('alumni')): ?> active <?php endif; ?>">
                                <i class="fas fa-home me-2"></i> Dashboard
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('alumni.manage')): ?>
                            <a href="/alumni/manage" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->is('alumni/manage*')): ?> active <?php endif; ?>">
                                <i class="fas fa-cogs me-2"></i> Manage
                            </a>
                            <?php endif; ?>
                        </nav>
        ...
        <?php if(\App\Helpers\NavigationHelper::canAccessModule('localization') || auth()->user()->hasRole('admin')): ?>
        ...
        <div class="accordion mb-2" id="localizationSidebarAccordion">
            <div class="accordion-item border-0 bg-transparent">
                ...
                <div id="localizationCollapse" class="accordion-collapse collapse" aria-labelledby="localizationHeading" data-bs-parent="#localizationSidebarAccordion">
                    <div class="accordion-body p-0">
                        <nav class="nav flex-column ms-3">
                            <?php if(auth()->user()->hasPermission('localization.view')): ?>
                            <a href="/localization" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->is('localization')): ?> active <?php endif; ?>">
                                <i class="fas fa-home me-2"></i> Dashboard
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('localization.manage')): ?>
                            <a href="/localization/manage" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->is('localization/manage*')): ?> active <?php endif; ?>">
                                <i class="fas fa-cogs me-2"></i> Manage
                            </a>
                            <?php endif; ?>
                        </nav>
