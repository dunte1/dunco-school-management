<?php $__env->startSection('title', 'Examination Management'); ?>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-4">
                    <div class="exam-quick-actions justify-content-end">
                        <a href="<?php echo e(route('examination.exams.create')); ?>" class="exam-action-btn">
                            <i class="fas fa-plus"></i> Create Exam
                        </a>
                        <a href="<?php echo e(route('examination.questions.index')); ?>" class="exam-action-btn">
            ...
            <div class="col-md-3">
                <div class="exam-stat-card">
                    ...
                    <div class="exam-stat-content">
                        ...
                        <div class="exam-stat-value"><?php echo e($exams->total() ?? 24); ?></div>
            ...
            <div class="col-md-3">
                <div class="exam-stat-card">
                    ...
                    <div class="exam-stat-content">
                        ...
                        <div class="exam-stat-value"><?php echo e($upcomingExams->count() ?? 8); ?></div>
                        <div class="exam-stat-change">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="upcoming-exam-card">
                        <div class="upcoming-exam-header">
                            <div class="exam-name"><?php echo e($exam->name ?? 'Sample Exam'); ?></div>
                            <div class="exam-meta"><?php echo e($exam->examType->name ?? 'Final Exam'); ?> • <?php echo e($exam->academic_year ?? '2024'); ?> - <?php echo e($exam->term ?? 'Term 1'); ?></div>
                                </div>
                        <div class="upcoming-exam-body">
                            <div class="exam-badges">
                                <span class="exam-badge primary"><?php echo e($exam->is_online ?? true ? 'ONLINE' : 'OFFLINE'); ?></span>
                                <?php if($exam->enable_proctoring ?? false): ?>
                                <span class="exam-badge purple">Proctored</span>
                                    <?php endif; ?>
                                </div>
                            <div class="exam-date">
                                <i class="fas fa-calendar me-2"></i>
                                Starts: <?php echo e($exam->start_date ? $exam->start_date->format('M d, Y') : 'Dec 15, 2024'); ?>

                            </div>
                            <div class="exam-actions">
                                <span class="exam-status <?php echo e(strtolower($exam->status ?? 'published')); ?>"><?php echo e(strtoupper($exam->status ?? 'PUBLISHED')); ?></span>
        ...
        <div class="exam-table-container">
            <div class="table-responsive">
                <table class="table exam-table">
                    ...
                    <tbody>
                        <?php if(isset($exams) && $exams->count() > 0): ?>
                        <?php $__currentLoopData = $exams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td>
                                    <div class="fw-bold" style="color:#1e293b;"><?php echo e($exam->name); ?></div>
                                <div class="text-muted"><?php echo e($exam->code); ?></div>
                            </td>
                                <td>
                                    <span class="badge bg-info text-dark"><?php echo e($exam->examType->name ?? 'Final Exam'); ?></span>
                                </td>
                                <td>
                                    <div><?php echo e($exam->start_date ? $exam->start_date->format('M d, Y') : 'Dec 15, 2024'); ?></div>
                                    <div class="text-muted"><?php echo e($exam->duration_minutes ?? 120); ?> min</div>
                                </td>
                                <td>
                                    <span class="exam-status <?php echo e(strtolower($exam->status ?? 'published')); ?>"><?php echo e(strtoupper($exam->status ?? 'PUBLISHED')); ?></span>
                            </td>
                            <td>
                                    <?php if($exam->is_online ?? true): ?>
                                    <span class="exam-feature-badge">Online</span>
                                <?php endif; ?>
                                    <?php if($exam->enable_proctoring ?? false): ?>
                                    <span class="exam-feature-badge">Proctored</span>
                                <?php endif; ?>
                                    <?php if($exam->show_results_immediately ?? false): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\dunth\Documents\duncoschool\Modules/Examination/resources/views/exams/index.blade.php ENDPATH**/ ?>