    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('library.books.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="author_id" name="author_id">
...
unset($__errorArgs, $__bag); ?>" id="publisher_id" name="publisher_id">
...
unset($__errorArgs, $__bag); ?>" id="status" name="status">
                                        ...
                                        <option value="borrowed" <?php echo e(old('status') == 'borrowed' ? 'selected' : ''); ?>>Borrowed</option>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="year" name="year" value="<?php echo e(old('year')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                   id="cover_image" name="cover_image" value="<?php echo e(old('cover_image')); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-3">
                            ...
                            <input type="file" class="form-control <?php $__errorArgs = ['ebook_file'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="<?php echo e(route('library.books.index')); ?>" class="btn btn-secondary">Cancel</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\dunth\Documents\duncoschool\Modules/Library/resources/views/books/create.blade.php ENDPATH**/ ?>