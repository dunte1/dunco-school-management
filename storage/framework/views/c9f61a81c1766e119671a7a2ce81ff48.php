...
<body>
    ...
    <nav class="sidebar d-flex flex-column shadow-lg" id="sidebarNav" aria-label="Main navigation" style="background: linear-gradient(135deg, #1a237e 0%, #3949ab 100%);">
        ...
        <?php if(auth()->check() && (\App\Helpers\NavigationHelper::canAccessModule('core') || auth()->user()->hasRole('admin'))): ?>
                ...
                <div id="coreCollapse" class="accordion-collapse collapse" aria-labelledby="coreHeading" data-bs-parent="#sidebarMainAccordion">
                    <div class="accordion-body p-0">
                        <nav class="nav flex-column ms-3">
                            <?php if(auth()->check() && auth()->user()->hasPermission('schools.view')): ?>
                            ...
                            <?php endif; ?>
                            <?php if(auth()->check() && auth()->user()->hasPermission('permissions.view')): ?>
                            ...
                            <?php endif; ?>
                            <?php if(auth()->check() && auth()->user()->hasPermission('audit.view')): ?>
        ...
        <?php endif; ?>
        <?php if(auth()->check() && auth()->user()->hasPermission('settings.view')): ?>
        ...
        <?php endif; ?>
        <?php if(auth()->check() && (\App\Helpers\NavigationHelper::canAccessModule('hr') || auth()->user()->hasRole('admin'))): ?>
        ...
        <div class="accordion-item border-0 bg-transparent">
            ...
            <div id="hrCollapse" class="accordion-collapse collapse" aria-labelledby="hrHeading" data-bs-parent="#sidebarMainAccordion">
                    <div class="accordion-body p-0">
                        <nav class="nav flex-column ms-3">
                            <?php if(auth()->check() && auth()->user()->hasPermission('hr.view')): ?>
                            ...
                            <?php endif; ?>
                            <?php if(auth()->check() && auth()->user()->hasPermission('hr.staff.view')): ?>
                            ...
                            <?php endif; ?>
                            <?php if(auth()->check() && auth()->user()->hasPermission('hr.leave.view')): ?>
                            ...
                            <?php endif; ?>
                            <?php if(auth()->check() && auth()->user()->hasPermission('hr.payroll.view')): ?>
                            ...
                            <?php endif; ?>
                            <?php if(auth()->check() && auth()->user()->hasPermission('hr.contract.view')): ?>
                            ...
                            <?php endif; ?>
                            <?php if(auth()->check() && auth()->user()->hasPermission('hr.departments.view')): ?>
        ...
        <?php endif; ?>
        <?php if(auth()->check() && (\App\Helpers\NavigationHelper::canAccessModule('academic') || auth()->user()->hasRole('admin'))): ?>
        ...
        <?php endif; ?>
        <?php if(auth()->check() && \App\Helpers\NavigationHelper::canAccessModule('examination') || auth()->user()->hasRole('admin')): ?>
        ...
        <?php if(auth()->check() && \App\Helpers\NavigationHelper::canAccessModule('library') || auth()->user()->hasRole('admin')): ?>
        ...
        <?php if(auth()->check() && (\App\Helpers\NavigationHelper::canAccessModule('chatbot') || auth()->user()->hasRole('admin'))): ?>
        ...
        <div class="accordion mb-2" id="chatbotSidebarAccordion" data-module="chatbot">
            <div class="accordion-item border-0 bg-transparent">
                ...
                <div id="chatbotCollapse" class="accordion-collapse collapse" aria-labelledby="chatbotHeading" data-bs-parent="#chatbotSidebarAccordion">
                    <div class="accordion-body p-0">
                        <nav class="nav flex-column ms-3">
                            <?php if(auth()->check() && auth()->user()->hasPermission('chatbot.view')): ?>
                            <a href="<?php echo e(route('chatbot.index')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('chatbot.index')): ?> active <?php endif; ?>" data-permission="chatbot.view">
                                <i class="fas fa-comments me-2"></i> Chat Interface
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->check() && auth()->user()->hasPermission('chatbot.admin')): ?>
                            <a href="<?php echo e(route('chatbot.admin.dashboard')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('chatbot.admin.dashboard')): ?> active <?php endif; ?>" data-permission="chatbot.admin">
                                <i class="fas fa-tachometer-alt me-2"></i> Dashboard
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->check() && auth()->user()->hasPermission('chatbot.admin')): ?>
                            <a href="<?php echo e(route('chatbot.admin.settings')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('chatbot.admin.settings')): ?> active <?php endif; ?>" data-permission="chatbot.admin">
                                <i class="fas fa-cog me-2"></i> Settings
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->check() && auth()->user()->hasPermission('chatbot.admin')): ?>
                            <a href="<?php echo e(route('chatbot.admin.usage')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('chatbot.admin.usage')): ?> active <?php endif; ?>" data-permission="chatbot.admin">
                                <i class="fas fa-chart-bar me-2"></i> Usage Statistics
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->check() && auth()->user()->hasPermission('chatbot.admin')): ?>
                            <a href="<?php echo e(route('chatbot.admin.models')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('chatbot.admin.models')): ?> active <?php endif; ?>" data-permission="chatbot.admin">
                                <i class="fas fa-brain me-2"></i> AI Models
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->check() && auth()->user()->hasPermission('chatbot.admin')): ?>
                            <a href="<?php echo e(route('chatbot.admin.health')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('chatbot.admin.health')): ?> active <?php endif; ?>" data-permission="chatbot.admin">
        ...
        <?php if(auth()->check() && (\App\Helpers\NavigationHelper::canAccessModule('finance') || auth()->user()->hasRole('admin'))): ?>
                ...
                <div id="financeCollapse" class="accordion-collapse collapse" aria-labelledby="financeHeading" data-bs-parent="#financeSidebarAccordion">
                    <div class="accordion-body p-0">
                        <nav class="nav flex-column ms-3">
                            ...
                            <a href="<?php echo e(route('finance.index')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('finance.index')): ?> active <?php endif; ?>" data-permission="finance.view">
                                <i class="fas fa-home me-2"></i> Dashboard
                            </a>
                            <?php endif; ?>
        ...
        <?php if(auth()->check() && (\App\Helpers\NavigationHelper::canAccessModule('timetable') || auth()->user()->hasRole('admin'))): ?>
            ...
            <div class="accordion-item border-0 bg-transparent">
                ...
                <div id="timetableCollapse" class="accordion-collapse collapse" aria-labelledby="timetableHeading" data-bs-parent="#timetableSidebarAccordion">
                    ...
                    <nav class="nav flex-column ms-3">
                        ...
                        <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('timetable.settings.view')): ?>
                            <a href="<?php echo e(route('timetable.settings')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('timetable.settings')): ?> active <?php endif; ?>">
                                <i class="fas fa-cogs me-2"></i> Settings
                            </a>
                            <?php endif; ?>
                    </nav>
        ...
        <?php endif; ?>
        <?php if(auth()->check() && (\App\Helpers\NavigationHelper::canAccessModule('portal') || auth()->user()->hasRole('admin'))): ?>
        ...
        <div class="accordion mb-2" id="portalSidebarAccordion">
            ...
            <span class="nav-text">Student/Parent Portal</span>
                ...
                <div id="portalCollapse" class="accordion-collapse collapse" aria-labelledby="portalHeading" data-bs-parent="#portalSidebarAccordion">
                    <div class="accordion-body p-0">
                        <nav class="nav flex-column ms-3">
                            <?php if(auth()->user()->hasPermission('portal.view')): ?>
                            <a href="<?php echo e(route('portal.dashboard')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('portal.dashboard')): ?> active <?php endif; ?>">
                                <i class="fas fa-home me-2"></i> Dashboard
        </a>
        <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('portal.academics.view')): ?>
                            <a href="<?php echo e(route('portal.academics')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('portal.academics')): ?> active <?php endif; ?>">
                                <i class="fas fa-graduation-cap me-2"></i> Academics
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('portal.schedule.view')): ?>
                            <a href="<?php echo e(route('portal.schedule')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('portal.schedule')): ?> active <?php endif; ?>">
                                <i class="fas fa-calendar-alt me-2"></i> Schedule
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('portal.materials.view')): ?>
                            <a href="<?php echo e(route('portal.materials')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('portal.materials')): ?> active <?php endif; ?>">
                                <i class="fas fa-book me-2"></i> Materials
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('portal.assignments.view')): ?>
                            <a href="<?php echo e(route('portal.assignments')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('portal.assignments')): ?> active <?php endif; ?>">
                                <i class="fas fa-book-open me-2"></i> Assignments
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('portal.finance.view')): ?>
                            <a href="<?php echo e(route('portal.finance')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('portal.finance')): ?> active <?php endif; ?>">
                                <i class="fas fa-money-bill-wave me-2"></i> Finance
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('portal.communication.view')): ?>
                            <a href="<?php echo e(route('portal.communication')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('portal.communication')): ?> active <?php endif; ?>">
        ...
        <?php endif; ?>
        <?php if(auth()->check() && (\App\Helpers\NavigationHelper::canAccessModule('attendance') || auth()->user()->hasRole('admin'))): ?>
        ...
        <?php endif; ?>
        <?php if(auth()->check() && (\App\Helpers\NavigationHelper::canAccessModule('communication') || auth()->user()->hasRole('admin'))): ?>
                ...
                <div id="communicationCollapse" class="accordion-collapse collapse" aria-labelledby="communicationHeading" data-bs-parent="#communicationSidebarAccordion">
                    <div class="accordion-body p-0">
                        <nav class="nav flex-column ms-3">
                            ...
                            <a href="<?php echo e(route('communication.announcements')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('communication.announcements.*')): ?> active <?php endif; ?>">
        ...
        <?php endif; ?>
        <?php if(auth()->check() && (auth()->user()->hasRole('admin') || \App\Helpers\NavigationHelper::canAccessModule('hostel'))): ?>
        ...
        <div class="accordion mb-2" id="hostelSidebarAccordion">
            <div class="accordion-item border-0 bg-transparent">
                ...
                <div id="hostelCollapse" class="accordion-collapse collapse" aria-labelledby="hostelHeading" data-bs-parent="#hostelSidebarAccordion">
                    <div class="accordion-body p-0">
                        <nav class="nav flex-column ms-3">
                            <?php if(auth()->user()->hasRole('admin') || auth()->user()->hasPermission('hostel.view')): ?>
                            ...
                            <?php endif; ?>
                            <?php if(auth()->user()->hasRole('admin') || auth()->user()->hasPermission('hostel.hostels.view')): ?>
                            <a href="<?php echo e(route('hostel.hostels.index')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('hostel.hostels.*')): ?> active <?php endif; ?>">
                                <i class="fas fa-building me-2"></i> Hostels
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasRole('admin') || auth()->user()->hasPermission('hostel.allocations.view')): ?>
                            ...
                            <?php endif; ?>
                            <?php if(auth()->user()->hasRole('admin') || auth()->user()->hasPermission('hostel.rooms.view')): ?>
                            ...
                            <?php endif; ?>
                            <?php if(auth()->user()->hasRole('admin') || auth()->user()->hasPermission('hostel.floors.view')): ?>
                            ...
                            <?php endif; ?>
                            <?php if(auth()->user()->hasRole('admin') || auth()->user()->hasPermission('hostel.beds.view')): ?>
                            ...
                            <?php endif; ?>
                            <?php if(auth()->user()->hasRole('admin') || auth()->user()->hasPermission('hostel.fees.view')): ?>
                            ...
                            <?php endif; ?>
                            <?php if(auth()->user()->hasRole('admin') || auth()->user()->hasPermission('hostel.issues.view')): ?>
                            ...
                            <?php endif; ?>
                            <?php if(auth()->user()->hasRole('admin') || auth()->user()->hasPermission('hostel.leave.view')): ?>
                            ...
                            <?php endif; ?>
                            <?php if(auth()->user()->hasRole('admin') || auth()->user()->hasPermission('hostel.visitors.view')): ?>
                            ...
                            <?php endif; ?>
                            <?php if(auth()->user()->hasRole('admin') || auth()->user()->hasPermission('hostel.announcements.view')): ?>
                            ...
                            <?php endif; ?>
                            <?php if(auth()->user()->hasRole('admin') || auth()->user()->hasPermission('hostel.wardens.view')): ?>
                            ...
                            <?php endif; ?>
                            <?php if(auth()->user()->hasRole('admin') || auth()->user()->hasPermission('hostel.reports.view')): ?>
        ...
        <?php endif; ?>
        <?php if(auth()->check() && (auth()->user()->hasRole('admin') || \App\Helpers\NavigationHelper::canAccessModule('transport'))): ?>
        ...
        <div class="accordion mb-2" id="transportSidebarAccordion">
            <div class="accordion-item border-0 bg-transparent">
                ...
                <div id="transportCollapse" class="accordion-collapse collapse" aria-labelledby="transportHeading" data-bs-parent="#transportSidebarAccordion">
                    <div class="accordion-body p-0">
                        <nav class="nav flex-column ms-3">
                            <?php if(auth()->user()->hasRole('admin') || auth()->user()->hasPermission('transport.view')): ?>
                            <a href="<?php echo e(route('transport.index')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('transport.index')): ?> active <?php endif; ?>">
                                <i class="fas fa-home me-2"></i> Dashboard
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasRole('admin') || auth()->user()->hasPermission('transport.vehicles.view')): ?>
                            <a href="<?php echo e(route('transport.vehicles.index')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('transport.vehicles.*')): ?> active <?php endif; ?>">
                                <i class="fas fa-car me-2"></i> Vehicles
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasRole('admin') || auth()->user()->hasPermission('transport.routes.view')): ?>
                            <a href="<?php echo e(route('transport.routes.index')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('transport.routes.*')): ?> active <?php endif; ?>">
                                <i class="fas fa-route me-2"></i> Routes
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasRole('admin') || auth()->user()->hasPermission('transport.drivers.view')): ?>
                            <a href="<?php echo e(route('transport.drivers.index')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('transport.drivers.*')): ?> active <?php endif; ?>">
                                <i class="fas fa-user-tie me-2"></i> Drivers
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasRole('admin') || auth()->user()->hasPermission('transport.trips.view')): ?>
                            <a href="<?php echo e(route('transport.trips.index')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('transport.trips.*')): ?> active <?php endif; ?>">
                                <i class="fas fa-route me-2"></i> Trips
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasRole('admin') || auth()->user()->hasPermission('transport.reports.view')): ?>
                            <a href="<?php echo e(route('transport.reports')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('transport.reports')): ?> active <?php endif; ?>">
                                <i class="fas fa-chart-bar me-2"></i> Reports
                            </a>
                            <?php endif; ?>
                        </nav>
        ...
        <?php if(auth()->check() && (\App\Helpers\NavigationHelper::canAccessModule('document') || auth()->user()->hasRole('admin'))): ?>
                ...
                <div id="documentCollapse" class="accordion-collapse collapse" aria-labelledby="documentHeading" data-bs-parent="#documentSidebarAccordion">
                    <div class="accordion-body p-0">
                        <nav class="nav flex-column ms-3">
                            ...
                            <a href="<?php echo e(route('document.index')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('document.index')): ?> active <?php endif; ?>">
                                <i class="fas fa-home me-2"></i> Dashboard
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('document.upload.view')): ?>
                            <a href="<?php echo e(route('document.upload')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('document.upload.*')): ?> active <?php endif; ?>">
                                <i class="fas fa-upload me-2"></i> Upload
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('document.manage.view')): ?>
                            <a href="<?php echo e(route('document.manage')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('document.manage.*')): ?> active <?php endif; ?>">
        ...
        <?php endif; ?>
        <?php if(auth()->check() && (\App\Helpers\NavigationHelper::canAccessModule('notification') || auth()->user()->hasRole('admin'))): ?>
                ...
                <div id="notificationCollapse" class="accordion-collapse collapse" aria-labelledby="notificationHeading" data-bs-parent="#notificationSidebarAccordion">
                    <div class="accordion-body p-0">
                        <nav class="nav flex-column ms-3">
                            ...
                            <a href="<?php echo e(route('notification.index')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('notification.index')): ?> active <?php endif; ?>">
                                <i class="fas fa-home me-2"></i> Dashboard
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('notification.manage.view')): ?>
                            <a href="<?php echo e(route('notification.manage')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('notification.manage.*')): ?> active <?php endif; ?>">
                                <i class="fas fa-cogs me-2"></i> Manage
                            </a>
                            <?php endif; ?>
                        </nav>
        ...
        <?php endif; ?>
        <?php if(auth()->check() && (\App\Helpers\NavigationHelper::canAccessModule('api') || auth()->user()->hasRole('admin'))): ?>
                ...
                <div id="apiCollapse" class="accordion-collapse collapse" aria-labelledby="apiHeading" data-bs-parent="#apiSidebarAccordion">
                    <div class="accordion-body p-0">
                        <nav class="nav flex-column ms-3">
                            ...
                            <a href="<?php echo e(route('api.index')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('api.index')): ?> active <?php endif; ?>">
                                <i class="fas fa-home me-2"></i> Dashboard
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('api.manage.view')): ?>
                            <a href="<?php echo e(route('api.manage')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('api.manage.*')): ?> active <?php endif; ?>">
                                <i class="fas fa-cogs me-2"></i> Manage
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('api.users.view')): ?>
                            <a href="<?php echo e(route('api.users')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('api.users')): ?> active <?php endif; ?>">
                                <i class="fas fa-users me-2"></i> Users API
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('api.students.view')): ?>
                            <a href="<?php echo e(route('api.students')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('api.students')): ?> active <?php endif; ?>">
                                <i class="fas fa-user-graduate me-2"></i> Students API
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('api.staff.view')): ?>
                            <a href="<?php echo e(route('api.staff')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('api.staff')): ?> active <?php endif; ?>">
                                <i class="fas fa-user-tie me-2"></i> Staff API
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('api.classes.view')): ?>
                            <a href="<?php echo e(route('api.classes')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('api.classes')): ?> active <?php endif; ?>">
                                <i class="fas fa-chalkboard me-2"></i> Classes API
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('api.stats.view')): ?>
                            <a href="<?php echo e(route('api.stats')); ?>" class="nav-link d-flex align-items-center mb-1 text-white sidebar-link <?php if(request()->routeIs('api.stats')): ?> active <?php endif; ?>">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            ...
            <div class="d-flex align-items-center me-3">
                <a href="<?php echo e(route('chatbot.index')); ?>" class="btn btn-outline-primary btn-sm d-flex align-items-center gap-2" title="AI School Assistant">
...
<?php /**PATH C:\Users\dunth\Documents\duncoschool\resources\views/layouts/app.blade.php ENDPATH**/ ?>