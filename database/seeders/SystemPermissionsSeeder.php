...
class SystemPermissionsSeeder extends Seeder
{
    public function run()
    {
        $allPermissions = [
            ...
            // Nursing Module Permissions
            ['name' => 'nursing.dashboard.view', 'display_name' => 'View Nursing Dashboard', 'module' => 'Nursing'],
            ['name' => 'nursing.placements.view', 'display_name' => 'View Clinical Placements', 'module' => 'Nursing'],
            ['name' => 'nursing.placements.create', 'display_name' => 'Create Clinical Placements', 'module' => 'Nursing'],
            ['name' => 'nursing.placements.edit', 'display_name' => 'Edit Clinical Placements', 'module' => 'Nursing'],
            ['name' => 'nursing.placements.delete', 'display_name' => 'Delete Clinical Placements', 'module' => 'Nursing'],
            ['name' => 'nursing.placements.manage', 'display_name' => 'Manage Clinical Placements', 'module' => 'Nursing'],
            ['name' => 'nursing.logbooks.view', 'display_name' => 'View Clinical Logbooks', 'module' => 'Nursing'],
            ['name' => 'nursing.logbooks.create', 'display_name' => 'Create Clinical Logbooks', 'module' => 'Nursing'],
            ['name' => 'nursing.logbooks.review', 'display_name' => 'Review Clinical Logbooks', 'module' => 'Nursing'],
            ['name' => 'nursing.skills.view', 'display_name' => 'View Nursing Skills', 'module' => 'Nursing'],
            ['name' => 'nursing.skills.manage', 'display_name' => 'Manage Nursing Skills', 'module' => 'Nursing'],
            ['name' => 'nursing.skills.assess', 'display_name' => 'Assess Nursing Skills', 'module' => 'Nursing'],
            ['name' => 'nursing.competency.award', 'display_name' => 'Award Competency', 'module' => 'Nursing'],
            ['name' => 'nursing.attendance.view', 'display_name' => 'View Clinical Attendance', 'module' => 'Nursing'],
            ['name' => 'nursing.attendance.mark', 'display_name' => 'Mark Clinical Attendance', 'module' => 'Nursing'],
            ['name' => 'nursing.hours.view', 'display_name' => 'View Clinical Hours', 'module' => 'Nursing'],
            ['name' => 'nursing.hours.manage', 'display_name' => 'Manage Clinical Hours', 'module' => 'Nursing'],
            ['name' => 'nursing.hours.approve', 'display_name' => 'Approve Clinical Hours', 'module' => 'Nursing'],
            ['name' => 'nursing.instructors.manage', 'display_name' => 'Manage Clinical Instructors', 'module' => 'Nursing'],
            ['name' => 'nursing.reference.view', 'display_name' => 'View Reference Center', 'module' => 'Nursing'],
            ['name' => 'nursing.reference.create', 'display_name' => 'Create Reference Articles', 'module' => 'Nursing'],
            ['name' => 'nursing.reference.approve', 'display_name' => 'Approve Reference Articles', 'module' => 'Nursing'],
            ['name' => 'nursing.scenarios.view', 'display_name' => 'View Clinical Scenarios', 'module' => 'Nursing'],
            ['name' => 'nursing.scenarios.create', 'display_name' => 'Create Clinical Scenarios', 'module' => 'Nursing'],
            ['name' => 'nursing.assessments.view', 'display_name' => 'View Nursing Assessments', 'module' => 'Nursing'],
            ['name' => 'nursing.assessments.create', 'display_name' => 'Create Nursing Assessments', 'module' => 'Nursing'],
            ['name' => 'nursing.assessments.grade', 'display_name' => 'Grade Nursing Assessments', 'module' => 'Nursing'],
            ['name' => 'nursing.cpd.view', 'display_name' => 'View CPD Activities', 'module' => 'Nursing'],
            ['name' => 'nursing.cpd.manage', 'display_name' => 'Manage CPD Activities', 'module' => 'Nursing'],
            ['name' => 'nursing.reports.view', 'display_name' => 'View Nursing Reports', 'module' => 'Nursing'],
            ['name' => 'nursing.reports.export', 'display_name' => 'Export Nursing Reports', 'module' => 'Nursing'],
            ['name' => 'nursing.settings.manage', 'display_name' => 'Manage Nursing Settings', 'module' => 'Nursing'],
            ['name' => 'nursing.calculators.view', 'display_name' => 'View Educational Calculators', 'module' => 'Nursing'],
            ['name' => 'nursing.study.view', 'display_name' => 'View Study Center', 'module' => 'Nursing'],
            ['name' => 'nursing.study.manage', 'display_name' => 'Manage Study Center', 'module' => 'Nursing'],
        ];
